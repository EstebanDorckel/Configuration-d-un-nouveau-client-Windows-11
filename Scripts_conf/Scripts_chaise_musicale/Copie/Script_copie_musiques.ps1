##############################################
# SAUVEGARDE DE Musique VERS P:
##############################################

Clear-Host
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "   SAUVEGARDE DE Musique (C:\ -> P:\)   " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$DestRoot = "s:\Copie_Musique_$UserName"
$Dest     = "$DestRoot\Musique"

Write-Host "Utilisateur        : $UserName" -ForegroundColor DarkGray
Write-Host "Musique source      : $Source"   -ForegroundColor DarkGray
...
if (-not (Test-Path $Source)) {
    Write-Host "ERREUR : Musique introuvable." -ForegroundColor Red
