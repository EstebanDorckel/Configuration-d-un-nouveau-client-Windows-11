##############################################
# SAUVEGARDE DE C:\Mes Documents VERS P:
##############################################

Clear-Host
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "   SAUVEGARDE DE C:\Mes Documents (C:\ -> P:\)   " -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
$DestRoot = "P:\Copie_Documents_$UserName"
$Dest     = "$DestRoot\Documents"

Write-Host "Utilisateur        : $UserName" -ForegroundColor DarkGray
Write-Host "Documents source      : $Source"   -ForegroundColor DarkGray
...
if (-not (Test-Path $Source)) {
    Write-Host "ERREUR : Documents introuvable." -ForegroundColor Red
...
Write-Host ""
Write-Host "Copie des fichiers de Documents en cours..." -ForegroundColor Yellow
